package com.safi.apps.pms.config;
 ...
 *
 * NOTE: For production applications, it's highly recommended to use a connection pool
 * provided by Spring Boot (e.g., HikariCP, which is default with spring-boot-starter-data-jpa)
 * rather than managing direct connections like this. This example is for demonstration
 * purposes as per the user's request for a "separate class for jdbc Connection".
 */
@Component
public class MySQLConnection {
    ...
    /**
     * Initializes the JDBC connection after the bean has been constructed.
    ...
    public void init() {
        try {
            ...
            System.getLogger(MySQLConnection.class.getName()).log(System.Logger.Level.ERROR, (String) null, ex);
        }
    }
    ...
    /**
     * Closes the JDBC connection before the bean is destroyed.
